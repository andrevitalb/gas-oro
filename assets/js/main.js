...
$(document).ready(function () {
    ...
    //Custom
    $(document).on("click", '#fact-button', function () {
        let error = confirmFact();
        if (error) {
            $.ajax({
                type: "POST",
    ...
    function confirmFact() {
        let data = '****** Estos son los datos que ingresaste ******\n\n' +
            'Razón social: ' + $('#razonSocial').val() +
            '\nRFC: ' + $('#rfc').val() +
            '\nNo. de folio: ' + $('#folio').val() +
            '\nUso de CFDI: ' + $('#cfdi').val() +
            '\nNo. de pedido: ' + $('#pedido').val() +
            '\nForma de pago: ' + $('#pago').val() +
            '\nFecha de carga: ' + $('#fecha').val() +
            '\nUnidad: ' + $('#unidad').val() +
            '\nLitros: ' + $('#litros').val() +
            '\nCiduad: ' + $('#ciudad').val() +
            '\nEmail: ' + $('#email').val() +
        ...
        if(confirm(data)) return true;
            ...
            alert('Confirma tus datos antes de enviar');
            return false;
        }
    }
